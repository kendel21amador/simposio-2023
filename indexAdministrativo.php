...
<html lang="en">
  ...
  <title>Adminin Simposio 2023</title>
  <link rel="icon" style="filter: invert(100%);" type="image/png" href="./img/ucr/firma-promocional-con-texto-negro.png">
  <body class="hold-transition sidebar-mini layout-fixed">
     ...
     <div class="content-wrapper">
        <h1>Bienvendo al panel administrativo</h1>
     </div>
     </div>
     <!-- ./wrapper -->
     <!-- jQuery -->

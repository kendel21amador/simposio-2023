<?php
   ...
   $json_file = 'datos/invitados.json'; // Reemplaza 'ruta/del/archivo.json' con la ubicación real de tu archivo JSON
   $json_data = file_get_contents($json_file);
   $data = json_decode($json_data, true);
   
   // Función para eliminar un evento específico por su índice en la matriz de datos
   ...
   if (isset($_GET['eliminar']) && isset($_GET['indice'])) {
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
         <h2 style="text-align: center;" class="mt-1">
            <b>Invitados del simposio</b>
         </h2>
         <div class="row justify-content-center">
            <div class="col-12 col-md-8">
               <a href="formulario_invitados.php" class="btn btn-success"> <b>+</b> Agregar nuevo invitado</a>
               <div class=" mt-2 card">
                  <div class="card-body">
                     <table id="miTabla" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                           <?php foreach ($data as $indice => $dato) { ?>
                           <tr>
                              <td><?php echo $dato['Nombre']; ?></td>
                              <td><?php echo $dato['Profesion']; ?></td>
                              <td><?php echo substr($dato['Descripcion'], 0, 70); ?></td>
                              <td>
                                 <a href="?eliminar=true&indice=<?php echo $indice; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                              </td>
                           </tr>
                           <?php } ?>
                        </tbody>

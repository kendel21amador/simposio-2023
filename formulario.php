...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
     ...
     <div class="content-wrapper">
        <h1 class="mb-5" style="text-align: center;">Insertar taller</h1>
        <form action="insertar_evento.php" method="post" enctype="multipart/form-data">
           <div class="container">
              <div class="row">
                 <div class="col-7">
                    <div class="card">
                       <div class="card-body">
                          <div class="form-group">
                             <label for="fecha">Fecha del evento (YYYY/MM/DD):</label>
                          ...
                          <div class="form-group">
                             <label for="nombre">Invitado del evento:</label>
                             <input class="form-control" type="text" name="invitado" id="invitado" required>
                          </div>
                          <div class="form-group">
                             <label for="nombre">Profesión del invitado:</label>
                          ...
                          <div class="form-group">
                             <label for="nombre">Aula del evento:</label>
           ...
           <!-- Agrega más campos según la estructura del JSON (hora, invitado, profesión, etc.) -->
           <button style="margin-left: 50%;" type="submit" class="btn btn-primary"> Registrar</button>
        </form>
     </div>
     </div>
     <!-- ./wrapper -->
